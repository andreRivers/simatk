        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <h3 class="text-center">Form Permohonan Barang</h3>

                </div>
                <form method="post" action="<?= base_url('permohonan_atk_rsm/input'); ?>" enctype="multipart/form-data" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input id="merek" type="text" class="form-control" name="merek">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input id="jumlah" type="number" onkeyup="" class="form-control" name="jumlah">
                            </div>
                        ...
                        <div class="form-group">
                            <input type="submit" id="simpan" name="simpan" class="btn btn-primary col-sm-offset-3 " value="Kirim">
                            &nbsp;
