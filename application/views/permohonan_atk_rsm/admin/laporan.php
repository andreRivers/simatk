        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <h3 class="text-center">Cetak Laporan RSM</h3>

                </div>
                <form method="post" action="<?= base_url('permohonan_atk/cetakLaporan'); ?>" enctype="multipart/form-data" class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="nama_barang" class=" col-sm-3 control-label">Tanggal Awal Laporan</label>
                            <div class="col-sm-5">
                                <input id="tgl_awal" type="datetime-local" id="tgl_awal" name="tgl_awal" class="form-control">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input id="tgl_akhir" type="datetime-local" class="form-control" name="tgl_akhir">
                            </div>
