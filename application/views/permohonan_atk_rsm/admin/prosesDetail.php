<div class="col-xs-12">
    ...
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <button onclick="history.back();" class="btn btn-danger"><i class="fa fa-backward"></i> Kembali</button>
            <br><br>
                            ...
                            <td>
                                ...
                                <?php if ($user['role_id'] == '4') { ?>
                                    <?php if ($at['sts'] == '30') { ?>
                                        ...
                                        <button type="button" class="btn btn-danger" title="Tolak" data-toggle="modal" data-target="#tolaklkk"><i class="fa fa-times"></i> </button>
                                    <?php } ?>
...
<!-- Modal Pimpinan Tolak -->
<div class="modal fade" id="tolaklkk" role="dialog">
    <div class="modal-dialog">
